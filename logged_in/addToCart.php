...
if ($productResult && mysqli_num_rows($productResult) > 0) {
    ...
    if ($quantity > $availableQuantity) {
        echo '<script>alert("Sorry, product is out of stock."); window.location.href = "products.php";</script>';
        exit();
    }
    ...
    if (mysqli_num_rows($checkCartResult) > 0) {
        ...
        echo '<script>alert("Item added to cart successfully!"); window.location.href = "products.php";</script>';
    }
} else {
    echo '<script>alert("Product not found."); window.location.href = "homepage.php";</script>';
}
