    ...
    try {
        ...
        if (!in_array($imageExtension, $validImageExtension)) {
            ...
            if (move_uploaded_file($tmpName, $uploadPath)) {
                $query = "INSERT INTO invent_cupsize (name, image, category, qty, price) 
                        VALUES ('$name', '$newImageName', '$category', $qty, '$price')";
                if (mysqli_query($conn, $query)) {
                    echo "<script>alert('Product Added Successfully'); document.location.href = 'admin1_cupsize.php';</script>";
                } else {
...
if (isset($_POST['delete_selected'])) {
    if (isset($_POST['delete']) && !empty($_POST['delete'])) {
        ...
        $deleteQuery = "DELETE FROM invent_cupsize WHERE id IN ($productIds)";
...
$searchQuery = "SELECT id, name, image, category, qty, price, category_id FROM invent_cupsize WHERE name LIKE '%$searchTerm%' ORDER BY id DESC";
...
$categoryQuery = "SELECT DISTINCT category FROM categ_cupsize";
$categories = mysqli_query($conn, $categoryQuery);

if ($categoryFilter) {
    $searchQuery = "SELECT id, name, image, category, qty, price, category_id FROM invent_cupsize WHERE category = '$categoryFilter' ORDER BY id DESC";
} else {
    $searchQuery = "SELECT id, name, image, category, qty, price, category_id FROM invent_cupsize ORDER BY id DESC";
}
$products = mysqli_query($conn, $searchQuery);
...
if (isset($_POST['updateProduct'])) {
    ...
    $updateQuery = "UPDATE invent_cupsize SET name='$name', category='$category', qty=$qty, price='$price'";
        ...
        <div class="all">
            ...
            <div class="popup-overlay" id="popupOverlay">
                <div class="popup-content">
                    ...
                    <h1>Coffee Cup MANAGEMENT</h1>
                    <form action="" method="post" autocomplete="off" enctype="multipart/form-data">
                    <div class="form-row">
                            <label for="name">Coffee Cup Size:</label>
                            <input type="text" name="name" id="name" required>
                        </div>

                        <div class="form-row">
                            <div class="form-column">
                                <label for="image">Coffee Cup Image:</label>
                            ...
                            <div class="form-column">
                                ...
                                <select name="category" id="category" required>
                                    <?php
                                    $categoryQuery = mysqli_query($conn, "SELECT DISTINCT category FROM categ_cupsize");
            ...
            <div class="dynamic_flexible">
                <div class="view">
                    <h3 class="prod">Coffee Cup Management</h3>
            ...
            <div class="popup-overlay" id="editPopup">
                <div class="popup-content">
                    ...
                    <h1>Edit Coffee Cup</h1>
                    <form action="" method="post" enctype="multipart/form-data">
                        <input type="hidden" name="id" id="editId">

                        <div class="form-row">
                            <label for="editName">Coffee Cup Size:</label>
                            <input type="text" name="name" id="editName" required>
                        </div>

                        <div class="form-row">
                            <div class="form-column">
                                <label for="editImage">Coffee Cup Image:</label>
