<?php
    ...
    if($cartAction=='buy'){
          ...
          $savePaymentQuery = "UPDATE customer_history SET status = 'Order received' WHERE time_stamp = ?";
          $stmtPay = mysqli_prepare($conn, $savePaymentQuery);
        ...
        echo "<script>alert('Order completed!');window.location.href = 'customerhistory.php';</script>";
    }
