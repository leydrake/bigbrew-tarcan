...
<body>
        ...
        <div class="popup-overlay" id="popupOverlay">
            <div class="popup-content">
                ...
                <form action="" method="post" autocomplete="off" enctype="multipart/form-data">
                    ...
                    <button type="submit" class="add" name="submit">Add Category</button>
                </form>
            </div>
        </div>
    ...
    <div>
        <button class="addito" onclick="showpopup()">Add Category</button>
                        ...
                        ?>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <!-- <div class="edit-name-container">
                                        <label for="edit_name">Edit Category Name:</label>
                                        <input type="text" id="edit_name" name="edit_name" value="<?php echo htmlspecialchars($row['category']); ?>" required>
