...
<body>
    ...
    <div class="content-categories">
        <div class="categories-container">
            ...
            while ($row = mysqli_fetch_assoc($result)) {
                ...
                $categoryLink = "products.php?category=" . urlencode($categoryName) . "&email=" . urlencode($email);
    ...
    <div class="grid-items">
        ...
        while ($product = mysqli_fetch_assoc($result)) {
            echo '<a href="product_details.php?product_id=' . $product['product_id'] . '" class="product-link">';
            echo "<div class='card'>";
